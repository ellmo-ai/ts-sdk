...
// @generated from protobuf file "polay/v1/span.proto" (package "polay.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message polay.v1.Span
 */
 ...
 *
 * @generated from protobuf message polay.v1.ReportSpanRequest
 */
export interface ReportSpanRequest {
    /**
     * @generated from protobuf field: repeated polay.v1.Span spans = 1;
     */
    spans: Span[];
}
...
class ReportSpanRequest$Type extends MessageType<ReportSpanRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ReportSpanRequest): ReportSpanRequest {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated polay.v1.Span spans */ 1:
    ...
    internalBinaryWrite(message: ReportSpanRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated polay.v1.Span spans = 1; */
...
/**
 * @generated MessageType for protobuf message polay.v1.ReportSpanRequest
 */
