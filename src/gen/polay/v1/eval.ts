...
// @generated from protobuf file "polay/v1/eval.proto" (package "polay.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message polay.v1.EvalScore
 */
 ...
 *
 * @generated from protobuf message polay.v1.RecordEvalRequest
 */
 ...
 *
 * @generated from protobuf message polay.v1.MeaningfulEvalScore
 */
export interface MeaningfulEvalScore {
    ...
    /**
     * @generated from protobuf field: polay.v1.EvalOutcome outcome = 4;
     */
 ...
 *
 * @generated from protobuf message polay.v1.RecordEvalResponse
 */
export interface RecordEvalResponse {
    /**
     * @generated from protobuf field: polay.v1.EvalOutcome outcome = 1;
     */
    outcome: EvalOutcome; // Outcome of the eval
    /**
     * @generated from protobuf field: repeated polay.v1.EvalScore previous_eval_scores = 2;
     */
    previousEvalScores: EvalScore[]; // List of previous eval scores
    /**
     * @generated from protobuf field: repeated polay.v1.MeaningfulEvalScore meaningful_eval_scores = 3;
     */
 ...
 *
 * @generated from protobuf enum polay.v1.EvalOutcome
 */
...
/**
 * @generated MessageType for protobuf message polay.v1.EvalScore
 */
...
/**
 * @generated MessageType for protobuf message polay.v1.RecordEvalRequest
 */
...
class MeaningfulEvalScore$Type extends MessageType<MeaningfulEvalScore> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* float current_score */ 3:
                    ...
                    break;
                case /* polay.v1.EvalOutcome outcome */ 4:
    ...
    internalBinaryWrite(message: MeaningfulEvalScore, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* polay.v1.EvalOutcome outcome = 4; */
...
/**
 * @generated MessageType for protobuf message polay.v1.MeaningfulEvalScore
 */
...
class RecordEvalResponse$Type extends MessageType<RecordEvalResponse> {
    constructor() {
        super("polay.v1.RecordEvalResponse", [
            { no: 1, name: "outcome", kind: "enum", T: () => ["polay.v1.EvalOutcome", EvalOutcome] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RecordEvalResponse): RecordEvalResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* polay.v1.EvalOutcome outcome */ 1:
                    message.outcome = reader.int32();
                    break;
                case /* repeated polay.v1.EvalScore previous_eval_scores */ 2:
                    message.previousEvalScores.push(EvalScore.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated polay.v1.MeaningfulEvalScore meaningful_eval_scores */ 3:
    ...
    internalBinaryWrite(message: RecordEvalResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* polay.v1.EvalOutcome outcome = 1; */
        if (message.outcome !== 0)
            writer.tag(1, WireType.Varint).int32(message.outcome);
        /* repeated polay.v1.EvalScore previous_eval_scores = 2; */
        ...
        /* repeated polay.v1.MeaningfulEvalScore meaningful_eval_scores = 3; */
...
/**
 * @generated MessageType for protobuf message polay.v1.RecordEvalResponse
 */
