...
import { PolayService } from "./polay";
...
/**
 * @generated from protobuf service polay.v1.PolayService
 */
export interface IPolayServiceClient {
    /**
     * @generated from protobuf rpc: QueueTest(polay.v1.TestExecutionRequest) returns (google.protobuf.Empty);
     */
    queueTest(input: TestExecutionRequest, options?: RpcOptions): UnaryCall<TestExecutionRequest, Empty>;
    /**
     * @generated from protobuf rpc: ReportSpan(polay.v1.ReportSpanRequest) returns (google.protobuf.Empty);
     */
    reportSpan(input: ReportSpanRequest, options?: RpcOptions): UnaryCall<ReportSpanRequest, Empty>;
    /**
     * @generated from protobuf rpc: RecordEval(polay.v1.RecordEvalRequest) returns (polay.v1.RecordEvalResponse);
     */
 ...
 * @generated from protobuf service polay.v1.PolayService
 */
export class PolayServiceClient implements IPolayServiceClient, ServiceInfo {
    typeName = PolayService.typeName;
    methods = PolayService.methods;
    options = PolayService.options;
