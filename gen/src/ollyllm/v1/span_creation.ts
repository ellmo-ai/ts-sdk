...
// @generated from protobuf file "ollyllm/v1/span_creation.proto" (package "ollyllm.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message ollyllm.v1.SpanCreationRequest
 */
...
class SpanCreationRequest$Type extends MessageType<SpanCreationRequest> {
    constructor() {
        super("ollyllm.v1.SpanCreationRequest", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SpanCreationRequest): SpanCreationRequest {
...
/**
 * @generated MessageType for protobuf message ollyllm.v1.SpanCreationRequest
 */
export const SpanCreationRequest = new SpanCreationRequest$Type();
